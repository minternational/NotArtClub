...
const TermsAndConditions = () => {
  return (
    <section id="privacypolicy">
      ...
      <p>
        Your privacy is important to us. It is Not Art Club&#39;s policy to
        ...
        across our website,{" "}
        <a href="https://notart.club">https://notart.club</a>, and other sites
        we own and operate.{" "}
      </p>
      <p>
        This policy is effective as of 11 May 2021 and was last updated on 11
        May 2021.{" "}
      </p>
      <br />
      <br />
